...
//        arguments.putSerializable(Employee.class.getSimpleName(), task);
...
//          for the back button in the toolbar
    ...
    private void showConfirmationDialog(){
        ...
        app.iggy.empleados.AppDialog dialog = new app.iggy.empleados.AppDialog();
        Bundle args = new Bundle();
        args.putInt(app.iggy.empleados.AppDialog.DIALOG_ID, DIALOG_ID_CANCEL_EDIT);
        args.putString(app.iggy.empleados.AppDialog.DIALOG_MESSAGE, getString(R.string.cancelEditDiag_message));
        args.putInt(app.iggy.empleados.AppDialog.DIALOG_POSITIVE_RID, R.string.cancelEditDiag_positive_caption);
        args.putInt(app.iggy.empleados.AppDialog.DIALOG_NEGATIVE_RID, R.string.cancelEditDiag_negative_caption);
